...
- **追加インストール不要** - Windows 10/11 標準の .NET Framework 4.8 で動作

## ダウンロード

[Releases](https://github.com/sudosanet/binpatchwin/releases) から `binpatchwin.exe` をダウンロードしてください。

## 動作環境

- Windows 10 / 11 (追加インストール不要)
...
- .NET SDK (.NET Framework 4.8 ターゲットパック含む)
